...
################################################################
# This is a generated script based on design: bd_3539
#
...
CONFIG.C_SLOT_0_AXI_RUSER_WIDTH {32} \
CONFIG.C_SLOT_0_AXI_R_SEL {1} \
CONFIG.C_SLOT_0_AXI_WUSER_WIDTH {32} \
...
connect_bd_intf_net -intf_net Conn [get_bd_intf_ports SLOT_0_AXI] [get_bd_intf_pins g_inst/slot_0_axi]
  ...
  connect_bd_net -net net_slot_0_axi_awid [get_bd_pins g_inst/m_slot_0_axi_awid] [get_bd_pins ila_lib/probe11]
  connect_bd_net -net net_slot_0_axi_awlen [get_bd_pins g_inst/m_slot_0_axi_awlen] [get_bd_pins ila_lib/probe12]
  connect_bd_net -net net_slot_0_axi_awlock [get_bd_pins g_inst/m_slot_0_axi_awlock] [get_bd_pins ila_lib/probe13]
  ...
  connect_bd_net -net net_slot_0_axi_ruser [get_bd_pins g_inst/m_slot_0_axi_ruser] [get_bd_pins ila_lib/probe23]
  ...
  connect_bd_net -net net_slot_0_axi_wuser [get_bd_pins g_inst/m_slot_0_axi_wuser] [get_bd_pins ila_lib/probe26]
